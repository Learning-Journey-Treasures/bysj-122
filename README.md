# 1.项目介绍
- 系统角色：管理员、志愿者、学生
- 功能模块：学生管理、志愿者管理、宿舍信息管理、在线咨询管理、报道站管理、军训服装管理、一卡通管理、缴费信息管理等
...
- 配置tomcat，启动项目，其中，我将deployment下的application contex配置为 /ssmg48yd
- http://localhost:8080/ssmg48yd/admin/dist/index.html   管理员账号密码：abo/abo， 其他自行查表
